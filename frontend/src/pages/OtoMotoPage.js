...
const OtoMotoPage = () => {
  ...
  const categories = [
    { id: 'all', name: 'Tümü', icon: '🚗', description: 'Tüm ürünler' },
    { id: 'vehicle', name: 'Araç Alım Satım', icon: '🚙', description: 'Otomobil ve ticari araçlar' },
    { id: 'motorcycle', name: 'Motor Alım Satım', icon: '🏍️', description: 'Motosiklet ve scooter' },
    { id: 'equipment', name: 'Motor Ekipmanları', icon: '🧰', description: 'Kask, eldiven, aksesuar' },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col" data-testid="oto-moto-page">
      <Navbar />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Araç, motor ve ekipman alım satım ilanları
            </p>
          </div>
          ...
          <div className="mt-16 bg-gradient-to-r from-orange-600 to-orange-700 text-white p-8 rounded-xl text-center">
            <h3 className="text-2xl font-bold mb-4">Aracınızı veya Motorunuzu Satmak İster Misiniz?</h3>
