        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/randevu" className="text-gray-400 hover:text-white transition">
                  Randevu Al
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>📍 Hızırreis Sok. No:1A</li>
              <li>Bayrampaşa / İstanbul</li>
              <li className="mt-2">📞 0532 683 26 03</li>
              <li>✉️ bdgaraj1@gmail.com</li>
            </ul>
          </div>
        </div>

        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} BD Garaj. Tüm hakları saklıdır.</p>
        </div>
      </div>
    </footer>
  );
